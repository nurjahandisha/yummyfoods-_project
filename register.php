                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            ...
                                            if(isset($_SESSION['errors']['fname_error'])){
                                                ...
                                                <span class="text-danger"><?=$_SESSION['errors']['fname_error']?></span>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                                            ...
                                            if(isset($_SESSION['errors']['lname_error'])){
                                                ...
                                                <span class="text-danger"><?=$_SESSION['errors']['lname_error']?></span>
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            ...
                                            if(isset($_SESSION['errors']['password_error'])){
                                                ...
                                                <span class="text-danger"><?=$_SESSION['errors']['password_error']?></span>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            ...
                                            if(isset($_SESSION['errors']['confirm_password_error'])){
                                                ...
                                                <span class="text-danger"><?=$_SESSION['errors']['confirm_password_error']?></span>
